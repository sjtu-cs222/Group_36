...
class PrunningFineTuner_VGG16:
    ...
    def train(self, optimizer=None, epoches=10):
        ...
        for i in range(epoches):
            ...
            torch.save(self.model, "alexnet_model")
    ...
    def prune(self):
        ...
        for it_k in range(iterations):
            ...
            torch.save(model,"./pruned/alexnet_cifar10_prunned_%d" % it_k)
        ...
        torch.save(model, "alexnet_cifar10_prunned")
...
if __name__ == '__main__':
    ...
    if use_gpu:
        if args.train:
            ...
            if args.restore:
                model.load_state_dict(torch.load("alexnet_model").state_dict())
        elif args.prune:
            model = torch.load("alexnet_model").cuda()
    else:
        if args.train:
            ...
            model = torch.load("alexnet_model")
    ...
    if args.train:
        ...
        torch.save(model, "alexnet_model")
    elif args.prune:
        fine_tuner.prune()
    print("Done!\n")